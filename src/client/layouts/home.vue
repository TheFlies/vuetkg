<template>
  <div id="page-wrapper">
    ...
    <section id="main" class="container">
      ...
      <section class="box special">
        <header class="major">
          <h2>Introducing the ultimate mobile app
            <br /> for doing stuff with your phone</h2>
        ...
        <span class="image featured"><img :src="pic01" alt="" /></span>
      </section>
      ...
      <div class="row">
        <div class="6u 12u(narrower)">
          ...
          <section class="box special">
            <span class="image featured"><img :src="pic02" alt="" /></span>
        ...
        <div class="6u 12u(narrower)">
          ...
          <section class="box special">
            <span class="image featured"><img :src="pic03" alt="" /></span>
    ...
    <footer id="footer">
      ...
      <ul class="copyright">
        <li>&copy; The Flies. All rights reserved.</li>
        <li>Design:
