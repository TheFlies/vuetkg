...
module.exports = {
	...
	hashSecret: "G94h6zJcoia20cj0JQqeva9rb5PqidXII2LbJLcrfad",

	// Secret for session hashing
	sessionSecret: "E1k3xrnsK7Fer4QIcfet499MebfjNVoayi37yiGtYwS",
	...
	db: {
		uri: process.env.MONGO_URI || "mongodb://tkg:tkg@ds147454.mlab.com:47454/vuetkg",
		options: {
			user: process.env.MONGO_USERNAME || "tkg",
			pass: process.env.MONGO_PASSWORD || "tkg"
		}
	},
